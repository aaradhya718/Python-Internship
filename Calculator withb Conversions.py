...
while True:
    ...
    #CONVERSIONS
    elif choice == "5":  # Kilogram to Pounds
        try:
    ...
    elif choice == "6":  # Celsius to Fahrenheit
        try:
    ...
    elif choice == "7":  # Hours to Minutes
        try:
    ...
    elif choice == "8":  # Miles to Kilometers
        try:
    ...
    elif choice == "9":  # Meters to Kilometers
        try:
